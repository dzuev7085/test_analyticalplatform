...
class DebtClassification(models.Model):
    ...
    debt_classification_name = models.CharField(
        max_length=90,
        null=False,
        blank=False
    )

    debt_classification_description = models.TextField(
        max_length=500,
        null=False,
        blank=False
    )
